...
class InboxItem(SQLModel, table=True):
    ...
    content_hash: Optional[str] = Field(default=None, nullable=True, index=True, max_length=64)
    dedupe_key: Optional[str] = Field(default=None, nullable=True, index=True, max_length=200)
    save_count: int = Field(default=1, nullable=False)
    processing_attempts: int = Field(default=0, nullable=False)
    last_processing_error: Optional[str] = Field(default=None, nullable=True, max_length=500)
