...
class InboxItem(SQLModel, table=True):
    ...
    directory_id: Optional[int] = Field(
        default=None, nullable=True, foreign_key="directory.id", index=True
    )
    source: str = Field(default="extension", nullable=False)
    item_type: InboxItemType = Field(
        default=InboxItemType.TEXT, nullable=False, max_length=20
    )
    ...
    location_city: Optional[str] = Field(
        default=None, nullable=True, index=True, max_length=120
    )
    title: Optional[str] = Field(default=None, max_length=120)
    content: str = Field(default="", nullable=False)
    content_hash: Optional[str] = Field(
        default=None, nullable=True, index=True, max_length=64
    )
    dedupe_key: Optional[str] = Field(
        default=None, nullable=True, index=True, max_length=200
    )
    save_count: int = Field(default=1, nullable=False)
    processing_attempts: int = Field(default=0, nullable=False)
    last_processing_error: Optional[str] = Field(
        default=None, nullable=True, max_length=500
    )
